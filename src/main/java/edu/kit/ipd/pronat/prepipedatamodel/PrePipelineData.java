package edu.kit.ipd.pronat.prepipedatamodel;
...
public class PrePipelineData extends AbstractPrePipelineData {
	 ...
	 *             thrown iff the transcription string is missing
	 */
	 ...
	 * @throws MissingDataException
	 *             thrown iff no transcriptions were defined
	 */
	 ...
	 * @return the tokens
	 * @throws MissingDataException
	 *             thrown if no tokens were defined
	 */
	 ...
	 * @throws MissingDataException
	 *             thrown iff no main hypothesis was defined
	 */
	 ...
	 * @throws MissingDataException
	 *             thrown iff no alternative hypotheses were defined
	 */
	 ...
	 *
	 * @param hypothesis
	 *            the hypothesis to add
	 */
	public void addAltHypothesis(List<MainHypothesisToken> hypothesis) {
		if (altHypotheses == null) {
			altHypotheses = new ArrayList<List<MainHypothesisToken>>();
		}
	 ...
	 * @throws MissingDataException
	 *             thrown iff no tagged hypotheses were defined
	 */
	 ...
	 * @throws MissingDataException
	 *             thrown iff no tagged hypotheses were defined at the given index
	 */
	 ...
	 *
	 * @param taggedHypotheses
	 *            the taggedHypotheses to set
	 */
	 ...
	 *
	 * @param taggedHypothesis
	 *            the tagged hypothesis to add
	 */
	public void addTaggedHypothesis(List<Token> taggedHypothesis) {
		if (taggedHypotheses == null) {
			taggedHypotheses = new ArrayList<List<Token>>();
		}
	 ...
	 * @throws MissingDataException
	 *             thrown if no tagged input file path was defined
	 */
