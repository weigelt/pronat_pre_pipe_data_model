...
public class MainHypothesisToken extends AbstractHypothesisToken {
	...
	public MainHypothesisToken(String word, int position, double confidence, HypothesisTokenType type, double startTime, double endTime) {
		this(word, position, confidence, type, startTime, endTime, new ArrayList<AlternativeHypothesisToken>());
	}

	public MainHypothesisToken(String word, int position, double confidence, HypothesisTokenType type) {
		this(word, position, confidence, type, 0.0d, 0.0d, new ArrayList<AlternativeHypothesisToken>());
	}
	...
	/**
	 * @param alternatives
	 *            the alternative hypotheses to be set
	 */
	...
	/**
	 * @param alternative
	 *            the alternative hypothesis to be set
	 */
	 ...
	 *            the alternative hypothesis to be set
	 * @param index
	 *            the index to set the alternative hypothesis
	 */
